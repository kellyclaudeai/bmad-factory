...
- [x] E2E test: User sends message, appears immediately (optimistic UI)
- [x] E2E test: Message delivered to other users in <500ms
- [x] E2E test: Channel switching loads messages correctly
- [x] E2E test: Unread counts update in real-time
- [x] E2E test: User can create channel and send first message
- [x] E2E test: Direct messages work end-to-end
