...
**Fixed order — never changes:** John → Sally → Winston → Bob → Amelia
...
- Winston can freely rewrite architecture.md — Bob reads it and writes stories that reflect it
