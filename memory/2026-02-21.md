...
## Project States (03:42 CST)

| Project | Phase | Lifecycle | URL | Notes |
|---|---|---|---|---|
| Distill | qa | qa-feedback | https://distill-weld.vercel.app | 65/65, ready for QA. Tier fix (10/day Pro) dispatched to PL. Homepage is just "Distill" (Chrome ext — by design). Matt asked about landing page. |
| SentinelHire | qa | greenfield | https://sentinel-hire.vercel.app | Sally redesigning post-login screens (dispatched ~01:00 CST) |
| ReelRolla | qa | greenfield | https://reelrolla.vercel.app | Desktop redesign queued, awaiting Matt go-ahead |
| Masterpiece | testing→qa | greenfield | https://homageart-r2zcmbm8n-kelly-1224s-projects.vercel.app | 170/178 passing, Amelia fixing last 7. R2/og:image deferred (CONDITIONAL PASS approved). Will flip to QA when Amelia done. |
...
- QA walkthrough: Masterpiece — imminent (Amelia finishing fixes now)
- Go-ahead for ReelRolla desktop redesign (Sally → Bob → Amelia)
- Decision: Distill homepage — keep as-is (Chrome ext portal) or build a real landing page?
- R2/Cloudflare setup for Masterpiece og:image — deferred, post-launch

## Recent Decisions (03:29–03:42 CST)
- **Masterpiece R2**: deferred, CONDITIONAL PASS accepted, advancing to QA
- **Distill homepage**: currently just says "Distill" — Matt noticed, discussion pending (landing page?)
- **Stripe**: one account, per-project products with metadata[project] naming convention
