...
name: Drizzle
description: >
  Drizzle ORM patterns and gotchas for Postgres and SQLite. Use when writing
  database schemas, queries, migrations, or relations with Drizzle. Covers
  type-safe queries, joins, transactions, and common pitfalls.
