...
name: vercel
description: >
  Vercel CLI reference for deployments and project management. Use when deploying
  to Vercel, managing domains, setting environment variables, configuring build
  settings, or troubleshooting deployment issues.
