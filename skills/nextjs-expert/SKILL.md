...
version: 1.0.0
description: >
  Next.js 14/15 App Router comprehensive reference. Use when building or
  architecting Next.js applications — routing, layouts, Server/Client Components,
  Server Actions, Route Handlers, middleware, data fetching, caching, streaming,
  Suspense, error boundaries, or deployment configuration.
triggers:
  - Next.js
  - Next
  - nextjs
