...
description: >
  Responsive layout patterns for web applications. Use when building layouts that
  adapt across screen sizes, implementing mobile-first breakpoints, fluid typography
  with clamp(), container queries, responsive grids, adaptive navigation, or
  responsive images. Covers CSS Grid, Flexbox, viewport units, and Tailwind responsive utilities.
---
...
- `references/container-queries.md` — Container query deep dive, patterns, Tailwind integration
- `references/breakpoint-strategies.md` — Mobile-first, content-based breakpoints, preference queries
- `references/fluid-layouts.md` — clamp() formulas, fluid spacing, intrinsic sizing, viewport units
