...
version: 1.0.0
description: >
  shadcn/ui component library patterns. Use when building UI with shadcn/ui
  components, Tailwind CSS, react-hook-form + zod forms, theming, dark mode,
  sidebar layouts, or data tables.
triggers:
  - shadcn
  - shadcn/ui
  - radix
